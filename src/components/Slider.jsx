...
function Slider() {
  ...
  return (
    <div>
        <HiChevronLeft className="hidden md:block text-white text-[45px] absolute
        mx-8 mt-[150px] cursor-pointer" 
        onClick={()=>sliderLeft(elementRef.current)}/>
        <HiChevronRight className="hidden md:block text-white text-[45px] absolute
        mx-8 mt-[150px] cursor-pointer right-0
        "onClick={()=>sliderRight(elementRef.current)}/>
    
    <div className='flex overflow-x-auto no-scrollbar w-full px-16 py-4 
